 ...
 * 引き渡す(CompositeStationAdapter.getBoardingPosition参照)。確認できない
    ...
    segments: [
      {
        ...
        // fixtureのplatformId("pf_..."形式)とは異なり、確認できた到着番線の
        // ラベル(例:"3")をそのまま格納する。CompositeStationAdapter側で
        // "pf_"接頭辞の有無により両者を判別する(isPlainArrivalPlatformLabel参照)。
